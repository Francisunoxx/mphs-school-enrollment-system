...
import daoimpl.CurriculumDaoImpl_Orig;
...
public class CreateCurriculumForm_Orig extends javax.swing.JPanel {
    ...
    CurriculumDaoImpl_Orig cdi = new CurriculumDaoImpl_Orig();

    public CreateCurriculumForm_Orig() {
    ...
    private void initComponents() {
        ...
        subjectsListJtbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Subject Name", "Units", "Description", "Year Level"
            }
        ) {
...
//        JOptionPane.showMessageDialog(null, selectedSubjCode);
    ...
    private void saveCurriculumJbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveCurriculumJbtnActionPerformed
        if (jcmbGradeLevel.getSelectedIndex() > -1 && jcmbSchoolYearYearFrom.getSelectedIndex() > -1) {
            ...
            schoolYear.setYearFrom(selectedSyYearFrom);
            schoolYear.setYearTo(selectedSyYearTo);
            GradeLevel gradeLevel = new GradeLevel();
            gradeLevel.setLevel(selectedGradeLevel);
            Curriculum curriculum = new Curriculum();
            curriculum.setGradeLevel(gradeLevel);
            curriculum.setSchoolYear(schoolYear);
            
            if(cdi.curriculumExists(curriculum)){
