...
public class SchoolStaff extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        staffListPanel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        gridBagConstraints.weighty = 0.5;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        staffListPanel.add(jPanel3, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        staffListPanel.add(jPanel9, gridBagConstraints);

        add(staffListPanel, java.awt.BorderLayout.CENTER);
